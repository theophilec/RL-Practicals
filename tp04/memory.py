...
class Memory:
    def __init__(
        self, mem_size, prior=True, p_upper=1.0, epsilon=0.01, alpha=0.6, beta=1
    ):
    ...
    def is_full(self):
        if self.prior:
            return self.tree.nentities == self.mem_size
        else:
            return self.nentities == self.mem_size
